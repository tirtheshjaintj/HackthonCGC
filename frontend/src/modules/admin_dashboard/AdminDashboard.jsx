...
export default function AdminDashboard() {
  ...
  return (
    <div
      className="flex w-full max-h-screen min-h-screen bg-slate-50 "
      style={{ scrollbarWidth: "none" }}
    >
      <div
        className={`max-md:z-50 absolute min-h-full ${
          open
            ? "translate-x-0 flex-1  min-w-[270px] z-50"
            : "max-md:-translate-x-[130%] transition-all  w-[60px] "
      ...
      {/* Dashboard Content */}
      <div
        className="relative flex-1 mx-2 my-2 overflow-hidden overflow-y-auto bg-slate-50"
        style={{ scrollbarWidth: "none" }}
      >
        {/* Topbar */}
